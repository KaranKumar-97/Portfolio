...
import ME1 from "../../public/assets/Me.png?url";
import ME from "../../public/assets/Me.png?url";
...
export default function AboutMe({ sectionRef }) {
    ...
    const skills = "FULL STACK DEVELOPER DSA ENTHUSIAST GRAPHIC DESIGNER VIDEO EDITOR";
    const skills2 = "GRAPHIC DESIGNER VIDEO EDITOR FULL STACK DEVELOPER DSA ENTHUSIAST";

    const parentRef = useRef(null);
    const refs = [useRef(null), useRef(null), useRef(null), useRef(null), useRef(null)];
    const insideRefs = [useRef(null), useRef(null), useRef(null), useRef(null), useRef(null)];
            ...
            <div className="overflow-x-clip 2xl:-mb-[27rem] xl:-mb-[15rem] lg:-mb-[4rem] ">
                <div ref={parentRef} className="w-max">
                    <div ref={refs[0]} className="overflow-y-clip">
                        <h3 ref={insideRefs[0]} className="md:text-xl tracking-[8px] md:tracking-[30px] font-bold">
                            {aboutme}
                        </h3>
                    </div>
                    <div ref={refs[1]} className="overflow-y-clip">
                        <h3 ref={insideRefs[1]} className="mt-4 text-2xl md:text-7xl font-bold">
                            {name}
                        </h3>
                    </div>
                    <div ref={refs[2]} className="overflow-y-clip">
                        <h3 ref={insideRefs[2]} className=" text-2xl md:text-7xl font-bold opacity-75">
                            {skills}
                        </h3>
                    </div>
                    <div ref={refs[3]} className="overflow-y-clip">
                        <h3 ref={insideRefs[3]} className=" text-2xl md:text-7xl font-bold opacity-50">
                            {skills2}
                        </h3>
                    </div>
                    <div ref={refs[4]} className="overflow-y-clip">
                        <h3 ref={insideRefs[4]} className="mt-4 md:text-xl tracking-[8px] md:tracking-[30px] font-extrabold">
                            {aboutme}
                        </h3>
                    </div>
                </div>
            ...
            <div className="md:container md:mx-auto flex flex-col-reverse md:flex-row items-end gap-8 px-8 py-10 mt-[3vw]">
                <div className="w-full lg:w-3/4">
                    ...
                    <div className="mt-4 flex flex-wrap gap-1">
                        {["Full Stack Developer", "Problem Solver(DSA)", "Graphic Designer", "Video Editor"].map((value, index) => (
                            <div
                                key={index}
                                ref={tagsRef[index]}
                    ...
                    I'm Karan Kumar, a final-year B.Tech CSE student at MSIT, specializing in full-stack development using the MERN stack. With a strong grasp of Data Structures and Algorithms, I excel in building dynamic web applications and solving complex coding challenges, continuously exploring new technologies to enhance my skills.
                    </p>
                </div>
